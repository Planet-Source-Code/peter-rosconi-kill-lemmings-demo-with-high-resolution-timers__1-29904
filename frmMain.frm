...
Attribute tmrPhysics.VB_VarHelpID = -1
Private WithEvents tmrAdd As ccrpTimer
Attribute tmrAdd.VB_VarHelpID = -1
...
Private Sub tmrAdd_Timer(ByVal Milliseconds As Long)
    ' ******************************
...
Private Sub tmrPhysics_Timer(ByVal Milliseconds As Long)
    Dim i As Integer
    Dim n As Integer
